...
Pr{\' a}ce obsahuje kompletn{\' i} anal{\' y}zu, n{\' a}vrh a samotnou implementaci aplikace, jej{\' i}{\v z} hlavn{\' i} funkcionalitou je spr{\' a}va dron{\r u} a identifika{\v c}n{\' i}ch za{\v r}{\' i}zen{\' i} p{\v r}ipevn{\v e}n{\' y}ch k dron{\r u}m, zobrazov{\' a}n{\' i} zak{\' a}zan{\' y}ch z{\' o}n pro lety a pl{\' a}nov{\' a}n{\' i} a sledov{\' a}n{\' i} let{\r u} dron{\r u}.
...
\input{chapters/formal/glossaries.tex}
